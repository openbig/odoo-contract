...
class sale_configuration(osv.TransientModel):
    ...
    _columns = {
        'module_contractmanagement_licenses': fields.boolean('Modules and Application Views on Contracts'),
        'modules_product_categ': fields.many2one('product.category', 'Modules Category'),
        'applications_product_categ': fields.many2one('product.category', 'Application Category'),
    }
